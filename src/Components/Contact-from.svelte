...
<form id="form" on:submit={handleSubmit}>
  ...
  <fieldset>
    ...
    <input type="text" placeholder="Your name..." id="name-input" bind:value={name} required />
  </fieldset>
  ...
  <fieldset>
    ...
    <input type="email" placeholder="Your email..." id="email-input" bind:value={email} required />
  </fieldset>
  ...
  <fieldset>
    ...
    <textarea placeholder="Your Message..." id="message-input" bind:value={message} required></textarea>
  </fieldset>
